      ...
      <div className="product-bottom">
        ...
        <div className="product-bottom-price-and-cartActions">
          ...
          {!checkIfItemExistsInCartItemById(cartItems, {
            ...
            <div className="viewDetailsCardBottomButton">
              <span
                onClick={() => {
                  if (url) {
                    history.push({
                ...
                className="viewDetailsCardBottomButton__view"
              >
                <i className="fa fa-eye"></i>
                {lingual.isBangla ? "বিবরণী" : "Details"}
              </span>
              <span
                className={
                  inStock
                    ? "product-bottom-price-and-cartActions-cart-btn"
                    : "product-bottom-price-and-cartActions-cart-btn product-bottom-price-and-cartActions-cart-btn-disabled"
                }
