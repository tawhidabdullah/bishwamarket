...
import { InputGroup, FormControl, Col, Row, Modal } from "react-bootstrap";
...
const QuickviewDrawer = ({ open, toggleQuickviewDrawer }) => {
  return (
    <Fragment>
      ...
      <Modal show={open} onHide={toggleQuickviewDrawer} size="lg" centered>
        <Row>
          <Col md={6} sm={6} xs={12}>
            {/* <ImageContainer> */}
            <img
